...
class CreateLoginTask ( var username: String, var password: String, context: Context): AsyncTask<Unit, Unit, Boolean>() {
    override fun doInBackground(vararg params: Unit?): Boolean {
        var urlConnection: HttpURLConnection? = null
        try {
            //url
            val webServiceURL = URL("http://www.catherinewaltersontheweb.com/projects/directions/CreateUsers.php?username="+username+"&password="+password)
...
//
    companion object {
        private val TAG = "CreateLoginTask.kt"
