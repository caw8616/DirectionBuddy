...
class CheckLoginTask ( var username: String, var password: String, context: Context): AsyncTask<Unit, Unit, Boolean>() {
    override fun doInBackground(vararg params: Unit?): Boolean {
        var urlConnection: HttpURLConnection? = null
        try {
            //url
            val webServiceURL = URL("http://www.catherinewaltersontheweb.com/projects/directions/GetUsers.php?username="+username+"&password="+password)
...
//
    companion object {
        private val TAG = "CheckLoginTask.kt"
