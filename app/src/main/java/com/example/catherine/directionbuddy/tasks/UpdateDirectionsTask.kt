...
class UpdateDirectionsTask (
    ...
    override fun doInBackground(vararg params: Unit?): Boolean {
        ...
        try {
            var paramString = ""
//            if(contact == null) {
//                paramString = "name=" + name + "&address=" + address + "&city=" + city + "&state=" + state + "&zip" + zip + "&country=" + country + "&contact=null&user_id=" + user_id;
//
//            } else {
//                paramString = "name=" + name + "&address=" + address + "&city=" + city + "&state=" + state + "&zip" + zip + "&country=" + country + "&contact=" + contact + "&user_id=" + user_id;
...
//            }
            //url
            val webServiceURL = URL("http://www.catherinewaltersontheweb.com/projects/directions/Update.php?query=" + paramString)
...
//
    companion object {
        private val TAG = "UpdateDirectionsTask.kt"
